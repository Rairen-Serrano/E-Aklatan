        ...
        <div class="sidebar_container">
            ...
            <div class="sidebar_categories_wrapper">
                ...
                <div class="sidebar_categories">
                    <ul>
                        <li><a href="../html/ebooks-categories.php?genre_id=1">Thriller</a></li>
                        <li><a href="../html/ebooks-categories.php?genre_id=5">Finance</a></li>
                        <li><a href="../html/ebooks-categories.php?GenreID=4">General</a></li>
                        <li><a href="../html/ebooks-categories.php?GenreID=3">Computer</a></li>
                        <li><a href="../html/ebooks-categories.php?genre_id=2">Fiction and Literature</a></li>
                    </ul>
                </div>
            </div>
                ...
                <h3>TRENDING BOOKS</h3>
                    ...
                    do{ ?>
                        <div class="trendBook_wrapper">
                            <div class="book_box">
                                <a href="../html/ebook_info.php?ebook_id=<?php echo $Trendingebooks_set['ebook_id']?>">
        ...
        <div class="books_container">
            ...
            <div class="book-wrapper" id="book-wrapper">
                ...
                while ($ebook_set = mysqli_fetch_assoc($ebook_query)) {
                    ...
                    ?>
                    <a href="../html/ebook_info.php?ebook_id=<?php echo $ebook_set['ebook_id'] ?>" style="text-decoration: none; color: black;">
                        <div class="book">
                            <div class="book_img">
                                <?php
