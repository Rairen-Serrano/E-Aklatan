            ...
            <div class="sidebar_categories_wrapper">
                ...
                <div class="sidebar_categories">
                    <ul>
                        ...
                        <li><a href="../html/ebooks-categories.php?genre_id=4">General</a></li>
                        <li><a href="../html/ebooks-categories.php?genre_id=3">Computer</a></li>
                ...
                <h3>TRENDING BOOKS</h3>
                    ...
                    do{ ?>
                        <div class="trendBook_wrapper">
                            <div class="book_box">
                                <a href="../html/ebook_info.php?book_id=<?php echo $Trendingebooks_set['ebook_id']?>">
