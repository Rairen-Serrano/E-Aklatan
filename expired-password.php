<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_num_rows(mysqli_query($dbconnect, "SELECT * FROM users WHERE email='{$email}'")) > 0) {
            ...
            if ($users_query) {
                ...
                try {
                    ...
                    $mail->Body    = 'Here is the verification link <b><a href="http://e-aklatan.cloud/change-password.php?reset='.$code.'">http://e-aklatan.cloud/change-password.php?reset='.$code.'</a></b>';
        ...
        $msg = "<div class='alert alert-warning'>Your password has expired. Please change your password.</div>";
    } else {
                ...
                <div class="main-mockup">
                    <div class="w3l_form align-self">
                        <div class="left_grid_info">
                            <img src="images/expiredimg.png" alt="" style="height: 100%; width: 100%;">
                        </div>
                    </div>
