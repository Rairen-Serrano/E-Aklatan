            ...
            if ($password === $confirm_password) {
                ...
                if ($users_query) {
                    ...
                    try {
                        ...
                        $mail->SMTPAuth   = true;                                   //Enabl e SMTP authentication
                        ...
                        $mail->Body    = 'Here is the verification link <b><a href="https://e-aklatan.cloud/login.php?verification='.$code.'">https://e-aklatan.cloud/login.php?verification='.$code.'</a></b>';
