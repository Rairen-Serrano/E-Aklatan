    ...
    <div class="booksPage_container">
        ...
        <div class="books_container">
            <div class="books_header">
                <a href="journal.php" style="text-decoration: none; color: black;"><h2>Journals</h2></a>
            </div>
            ...
            <div class="book-wrapper" id="book-wrapper">
                ...
                while ($journal_set = mysqli_fetch_assoc($journal_query)) {
                    ...
                    ?>
                    <a href="journal_info.php?journal_id=<?php echo $journal_set['journal_id'] ?>" style="text-decoration: none; color: black;">
                        <div class="book">
                            <div class="book_img">
                                <?php
